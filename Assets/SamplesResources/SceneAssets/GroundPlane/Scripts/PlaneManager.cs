...
public class PlaneManager : MonoBehaviour
{
    ...
    SpiderPlacement spiderPlacement;
    ...
    void Start()
    {
        ...
        this.spiderPlacement = FindObjectOfType<SpiderPlacement>();
    ...
    public void HandleAutomaticHitTest(HitTestResult result)
    {
        ...
        if (CurrentPlaneMode == PlaneMode.PLACEMENT && !spiderPlacement.IsPlaced)
        {
            this.spiderPlacement.SetProductAnchor(null);
            ...
            switch (CurrentPlaneMode)
            {
                ...
                case PlaneMode.PLACEMENT:
                    ...
                    if (TrackingStatusIsTrackedOrLimited)
                    {
                        ...
                        if (!this.spiderPlacement.IsPlaced || TouchHandler.DoubleTap)
                        {
                        ...
                        if (!this.spiderPlacement.IsPlaced)
                        {
                            this.spiderPlacement.SetProductAnchor(this.placementAnchor.transform);
